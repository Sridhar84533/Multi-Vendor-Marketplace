    ...
    <div className="container dashboard-layout">
      <aside className="dashboard-sidebar">
        ...
        <ul className="dashboard-menu">
          ...
          <li className="dashboard-menu-item active" onClick={() => navigate('/seller/add-product')}>
      ...
      <main className="card" style={{ border: '1px solid #DDD' }}>
        <h1 style={{ fontSize: '1.8rem', fontWeight: 600, marginBottom: '1.5rem' }}>Add New Product</h1>
